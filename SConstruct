...
datetime_tests = SConscript(
    "datetime/tests/SConscript", variant_dir="build/datetime_tests"
)
...
fruit_tests = SConscript(
    "fruit/tests/SConscript", variant_dir="build/fruit_tests"
)
